		...
		<form class="form-horizontal" method="post" action="{{ route('admin-save-gallery') }}" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-md-7" >
						<div class="mb-3 row">
							<label for="name" class="col-md-3 text-right col-form-label">Name</label>
							<div class="col-md-9">
								<input name="name" class="form-control" type="text" value="" id="name" placeholder="Enter Page Name Here" >
							</div>
						</div>
						<div class="mb-3 row">
							<label for="name" class="col-md-3 text-right col-form-label">Slug</label>
							<div class="col-md-9">
					...
					<div class="col-md-5">	
						<div class="form-group row mb-2">
							<label for="state" class="col-sm-3 text-left control-label col-form-label">Enable OTP</label>
							<div class="col-sm-9">
								<select name="enable_otp" id="enable_otp" class="select2 form-control custom-select" style="width: 100%; height:36px;">	
									<option value="" selected>Enable Otp</option>
