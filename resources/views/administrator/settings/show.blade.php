		...
		<form id="formAccountSettings" method="POST" action="{{ route('admin-save-settings') }}" enctype="multipart/form-data" >
			...
			<div class="nav-align-top mb-4">
				<ul class="nav nav-pills flex-column flex-md-row mb-3" role="tablist">
					...
					<li class="nav-item">
						<button
							...
							role="tab"
							data-bs-toggle="tab"
							data-bs-target="#navs-pills-justified-utm"
							aria-controls="navs-pills-justified-utm"
							aria-selected="false"
						>
							<i class="tf-icons bx bx-message-square"></i> Utm Settings
						</button>
					</li>
					<li class="nav-item">
						<button
							...
							role="tab"
							data-bs-toggle="tab"
							data-bs-target="#navs-pills-justified-social-media"
							aria-controls="navs-pills-justified-social-media"
							aria-selected="false"
						>
				...
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="navs-pills-justified-utm" role="tabpanel">
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<div class="row">
										...
										<div class="mb-3 col-md-12">
											...
											<input
												class="form-control"
												type="text"
												name="utm_source" id="utm_source" placeholder="Enter Twitter Link Here" value="{{ (isset($settings['utm_source']))?$settings['utm_source']:'' }}"
												autofocus
											/>
										</div>		
										<div class="mb-3 col-md-12">
					...
					<div class="tab-pane fade" id="navs-pills-justified-social-media" role="tabpanel">
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<div class="row">
