    ...
    <section>
      ...
      <div class="container">
        ...
        <div class="td_tabs td_style_1">
          <ul class="td_tab_links td_style_2 td_type_1 td_mp_0 td_medium td_fs_20 td_heading_color wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
            <li class="active"><a href="#td_tab_1">Academic</a></li>
            <li><a href="#td_tab_2">Design</a></li>
            <li><a href="#td_tab_3">Development</a></li>
            <li><a href="#td_tab_4">E-learning</a></li>
            <li><a href="#td_tab_5">Blockchain</a></li>
            <li><a href="#td_tab_6">Professional</a></li>
            <li><a href="#td_tab_7">Technology</a></li>
          </ul>
          <div class="td_height_40 td_height_lg_40"></div>
              ...
              <div class="row td_gap_y_30 td_row_gap_30">
                  ...
                  <div class="td_card td_style_5">
                    <a href="course-details.html" class="td_card_thumb">
                      <span class="td_card_thumb_in td_radius_10">
                        <img src="{{ url('assets/frontend/img/home_3/course_thumb_1.jpg') }}" alt="">
                        <span class="td_card_label td_fs_14 td_white_color td_accent_bg">
                          <img src="{{ url('assets/frontend/img/icons/calendar_2.svg') }}" alt="">
                          10 Weeks
                        </span>
                      </span>
                    </a>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.35s">
                  <div class="td_card td_style_5">
                    <a href="course-details.html" class="td_card_thumb">
                      <span class="td_card_thumb_in td_radius_10">
                        <img src="{{ url('assets/frontend/img/home_3/course_thumb_2.jpg') }}" alt="">
                        <span class="td_card_label td_fs_14 td_white_color td_accent_bg">
                          <img src="{{ url('assets/frontend/img/icons/calendar_2.svg') }}" alt="">
                          08 Weeks
                        </span>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="td_card td_style_5">
                    <a href="course-details.html" class="td_card_thumb">
                      <span class="td_card_thumb_in td_radius_10">
                        <img src="{{ url('assets/frontend/img/home_3/course_thumb_3.jpg') }}" alt="">
                        <span class="td_card_label td_fs_14 td_white_color td_accent_bg">
                          <img src="{{ url('assets/frontend/img/icons/calendar_2.svg') }}" alt="">
                          12 Weeks
                        </span>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.45s">
                  <div class="td_card td_style_5">
                    <a href="course-details.html" class="td_card_thumb">
                      <span class="td_card_thumb_in td_radius_10">
                        <img src="{{ url('assets/frontend/img/home_3/course_thumb_4.jpg') }}" alt="">
                        <span class="td_card_label td_fs_14 td_white_color td_accent_bg">
                          <img src="{{ url('assets/frontend/img/icons/calendar_2.svg') }}" alt="">
                          20 Weeks
                        </span>
